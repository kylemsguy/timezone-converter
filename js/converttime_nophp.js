...
$(function(){
    ...
    $("#origtime").text(event_time + " GMT" + (event_tz_offset_h >= 0 ? "+" : "") + event_tz_offset_h + ":" + (parseInt(event_tz_offset_m) * (2/3)));| event_tz_offset_h === undefined || event_tz_offset_m === undefined)){
